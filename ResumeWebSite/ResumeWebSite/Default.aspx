...
<body id="page-top">
    ...
    <div class="container-fluid p-0">
                    ...
                    <div class="my-auto">
                        <h1 class="mb-0">
                            ...
                            <span class="text-primary">
                                <asp:Label runat="server" Text='<%# Eval("SOYAD")%>'></asp:Label>
                            </span>
                        </h1>
                        <div class="subheading mb-5">
                            Adres:
                           
                            <asp:Label ID="Label2" runat="server" Text='<%# Eval("ADRES")%>'></asp:Label><p></p>
                            Telefon:<asp:Label ID="Label3" runat="server" Text='<%# Eval("TELEFON")%>'></asp:Label>
                            <p></p>
                        ...
                        <p class="lead mb-5">
                            <asp:Label ID="Label6" runat="server" Text='<%# Eval("OZET")%>'></asp:Label>
                        </p>
                ...
                <ItemTemplate>
                    <div class="my-auto">
                        <div class="resume-item d-flex flex-column flex-md-row mb-5">
                            <div class="resume-content mr-auto">
                                <h3 class="mb-0">
                                    <asp:Label ID="Label14" runat="server" Text='<%# Eval("BASLIK")%>'></asp:Label></h3>
                                <div class="subheading mb-3">
                                    <asp:Label ID="Label12" runat="server" Text='<%# Eval("ALTBASLIK")%>'></asp:Label>
                                </div>
                                <div>
                                    <asp:Label ID="Label11" runat="server" Text='<%# Eval("ACIKLAMA")%>'></asp:Label></div>

                            </div>
                            <div class="resume-date text-md-right">
                                <span class="text-primary">
                                    <asp:Label ID="Label13" runat="server" Text='<%# Eval("TARIH")%>'></asp:Label>
                                </span>
                            </div>
                        </div>
        ...
        <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="interests">
            ...
            <h2 class="mb-5">İlgi Duyduğum Şeyler</h2>
            <asp:Repeater ID="Repeater5" runat="server">
                <ItemTemplate>
                    <p>
                        <asp:Label ID="Label15" runat="server" Text='<%# Eval("HOBI") %>'></asp:Label></p>
                    </div>
                </ItemTemplate>
            </asp:Repeater>
        </section>
                ...
                <ItemTemplate>
                    ...
                    <ul class="fa-ul mb-0">
                        <li class="mb-2">
                            ...
                            <asp:Label ID="Label5" runat="server" Text='<%# Eval("ODUL") %>'></asp:Label>
                        </li>
                    </ul>
                </ItemTemplate>
            </asp:Repeater>
